...
<html lang="en">
    ...
    <body>
        ...
        <div id="c">We Hear You!</div>
        <h4>Got questions? Don't worry, we are here to help! <br> For any enquiries, here are a few ways to reach out to us:</h4>
        <div id="container">
            <div id="ws"><img src="image/whatsapp.png" width="50" height="50" alt="whatsapp"> &nbsp;<b>Whatsapp / Call: </b>017-483 4185 (Ling Jia)</b></div>
            <div id="email"><img src="image/email.png" width="50" height="50" alt="gmail"> &nbsp;<b>Email: </b>tarucmusicfiesta@gmail.com</div>
        </div>
        <br>
        <div id="container2">
            <div id="fb"><img src="image/fb.png" width="40" height="40" alt="fb"> &nbsp;<b>Facebook (Society): </b>https://www.facebook.com/tarucmusicsociety/</div>
            <div id="fb2"><img src="image/fb.png" width="40" height="40" alt="fb"> &nbsp;<b>Facebook(Music Fiesta): </b>https://www.facebook.com/MusicFiestaTARUC/</div>
        </div>
        <br><br><br>
